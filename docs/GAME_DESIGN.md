...
After each job, you reinvest in hardware, cloud capacity, advertising, housing, cooling, and strange rule-changing perks. The goal is to assemble a build capable of processing ridiculous quantities of tokens without going bankrupt, overheating, missing deadlines, or being evicted.

## 2. Core loop

1. Choose a job.
2. Commit compute, cloud capacity, and modifiers.
...
7. Pay rent, electricity, cloud bills, debt, and other overhead.
8. Repeat until the run is won or collapses.

## 3. Primary resources

- **Cash:** Used for upgrades, rent, advertising, cloud compute, and emergency actions.
...
- **Demand:** Controls the quantity and quality of available jobs.
- **Reputation:** Unlocks larger contracts and better clients.

## 4. Strategic archetypes

- **Token Cannon:** Solves problems through overwhelming compute.
- **Prompt Engineer:** Uses fewer tokens with high efficiency.
- **Cloud Baron:** Rents massive temporary capacity and accepts financial risk.
...
- **Ad-Tech Goblin:** Generates low-quality products at industrial scale.
...
- Token caching
- Mysterious offshore provider
- “Unlimited” enterprise contract

Cloud compute is immediately scalable but can destroy the run through recurring costs or sudden price exposure.

### Advertising

Advertising increases the number and quality of job offers, but creates continuous spend. Some perks may convert reputation into demand or turn bad reviews into publicity.
...
- **Free Trial:** Cloud compute is free for three rounds, then costs 4×.
...
- **Founder Mode:** Advertising produces more leads; clients gain scope creep.

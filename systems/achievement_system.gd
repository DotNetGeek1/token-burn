...
func _context(run_state: RunState, score: Dictionary) -> Dictionary:
	...
	var context: Dictionary = {
		...
		"run.cascades_triggered": int(stats.get("cascades_triggered", 0)),
		"run.faults_suffered": int(stats.get("faults_suffered", 0)),
		"run.max_instability": float(stats.get("max_instability", 0.0)),
		"run.peak_overkill": float(stats.get("peak_overkill", 0.0)),
		"run.lifetime_overkill": float(stats.get("lifetime_overkill", 0.0)),
		"run.clean_completions": int(stats.get("clean_completions", 0)),
		"run.one_shot_completions": int(stats.get("one_shot_completions", 0)),
		"run.clean_one_shot_completions": int(stats.get("clean_one_shot_completions", 0)),
		"run.cool_completions": int(stats.get("cool_completions", 0)),
		"run.hot_one_shot_completions": int(stats.get("hot_one_shot_completions", 0)),
		"run.overkill_2x_completions": int(stats.get("overkill_2x_completions", 0)),
		"run.bugs_created": int(stats.get("bugs_created", 0)),
